...
With `rr_publisher_name()` you can query publishers' informations using the name of the publishers. The first argument `name` is the string to match publisher's names the second argument `qtype` gives the type of matching:
